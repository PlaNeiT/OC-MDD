...
('devUser1', 'dev1@example.com', 'hashed_password_1'),
...
(1, 1), -- devUser1 subscribes to JavaScript
(1, 2), -- devUser1 subscribes to Java
(2, 3); -- devUser2 subscribes to Python

-- Insert test articles
INSERT INTO articles (title, content, user_id, theme_id) VALUES
('Introduction to JavaScript', 'An article about JavaScript basics...', 1, 1),
...
('Great article on JavaScript!', 2, 1), -- devUser2 comments on devUser1's article on JavaScript
